						 ...
						 <hr>
					        ...
					        <div class="table-member">
									<table>
										...
										<c:forEach var="balist" items="${buyauList}">
											<tr>
											    <td>${balist.buy_mem_id}</td>											
												<td>
												<a href="/auction/aDetail?au_num=${balist.au_num }">${balist.product_title}</a>
												</td>
												<td>${balist.sell_mem_id}</td>
												<td>${balist.prod_sell_date}</td>	
											</tr>
										</c:forEach>	
									</table>
						       </div> 
