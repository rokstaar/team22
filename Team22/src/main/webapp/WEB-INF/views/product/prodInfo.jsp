...
<section style="display:flex; justify-content:center;">
	<form id="updateProd" action="/product/updateProd" method="post" onsubmit="return false;">
		...
		<c:out value="${request.requestURL}?${request.queryString}" />
		<div id="div-back" class="modal_back">
			<div id="div-share">
				<div class="ed share-group">
        
        <a class="ed share-button" onclick="sendSns('twitter','https://www.naver.com');">
          <span class="ed icon" style="color: #56aef7">
            <i class="fab fa-twitter-square fa-fw fa-lg fa-3x"></i>
          </span>
          
          <h5 class="ed share-sns-title">트위터</h5>
        </a>
        <a class="ed share-button" onclick="sendSns('facebook','<c:out value="${request.requestURL}" />'">
          <span class="ed icon" style="color: #515fa9">
            <i class="fab fa-facebook fa-fw fa-lg fa-3x"></i>
          </span>
