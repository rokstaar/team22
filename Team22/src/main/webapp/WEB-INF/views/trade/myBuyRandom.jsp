							...
							<%-- <c:if test="${vo.buy_mem_id eq sessionScope.id }"> --%>
								...
								<tbody class="body">
									<c:forEach var="vo" items="${myBuyRandom }">
										...
										<td>
											<fmt:formatNumber value="${vo.ran_bidPrice }" pattern="#,###" />원
										</td>
										<td>
										  <span onclick="window.location.href='/members/memberInfo?mem_id=${vo.ran_sellerId }'">
										   ${vo.ran_sellerId }
										  </span>
										</td>
									     <td>
								        			...
								        			<div class="modal-content"> 
								          					...
								          					<form action="/trade/reviewInsert" method="POST">
																...
																<input type="hidden" name="ran_num" value="${vo.ran_num}">
													         	<input type="button" id="cancel" value="취소" onclick="location.href='/trade/myBuyRandom'" > 
