...
public class ProductVO {
	...
	public ProductVO(Integer product_num, String product_seller, String product_cate, String product_title,
			String product_content, int product_price, Object product_pic, int product_readcount, Date product_date,
			String product_status, String product_grade, int product_favorite) {
		super();
